...
public class BenefitLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"NULL", "NUMBER", "LPAREN", "RPAREN", "LBRACE", "RBRACE", "LBRACK", "RBRACK", 
			"COMMA", "SEMI", "COLON", "ASSIGN", "GT", "LT", "BANG", "EQUAL", "LE", 
			"GE", "NOTEQUAL", "INC", "DEC", "ADD", "SUB", "MUL", "DIV", "MOD", "QUESTIONMARK", 
			"SIGN", "BOOLEANLITERAL", "CHARACTERLITERAL", "SINGLECHARACTER", "STRINGLITERAL", 
			"STRINGCHARACTERS", "STRINGCHARACTER", "ESCAPESEQUENCE", "IDENTIFIER", 
			"SCHEMELETTER", "SCHEMELETTERORDIGIT", "WS", "COMMENT", "LINE_COMMENT"
		};
	}
