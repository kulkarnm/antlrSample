...
public interface BenefitVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link BenefitParser#benefitPayComputeBlock}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitBenefitPayComputeBlock(BenefitParser.BenefitPayComputeBlockContext ctx);
	/**
	 * Visit a parse tree produced by {@link BenefitParser#separatedInstalmentDeliverySequencesExpression}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitSeparatedInstalmentDeliverySequencesExpression(BenefitParser.SeparatedInstalmentDeliverySequencesExpressionContext ctx);
	/**
